...
# numeroEmMetros = float(input('introduza um numero em metros: '))
# print(f'São {int(numeroEmMetros*100)} cm.')
...
# lado = int(input('introduza o valor do lado de um quadrado: '))
# area = lado*lado
# print(f'o dobro da area é: {2*area} m²')
